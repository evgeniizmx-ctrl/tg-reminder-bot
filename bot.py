...
async def cmd_start(m: Message):
    await m.answer(
        ...
        "Если только «завтра/послезавтра» — спрошу время для этого дня.\n"
        "Без цифр для «утром/вечером/днём/ночью» — всегда спрашиваю точные часы.\n"
